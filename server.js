    ...
    try {
      ...
      if (!existingMessage) {
        ...
        const mailOptions = {
          ...
          to: 'info@hotel54.com.tr,canberkugurlu@gmail.com', // Bildirimi almak istenen e-posta adresi
...
app.post('/saveResponse', async (req, res) => {
  try {
    ...
    const mailOptions = {
      ...
      to: 'info@hotel54.com.tr,canberkugurlu@gmail.com',  // Bildirimin gönderileceği e-posta adresi
...
app.post('/saveLaundry', async (req, res) => {
  try {
    ...
    const mailOptions = {
      ...
      to: 'info@hotel54.com.tr,canberkugurlu@gmail.com',  // Bildirim almak istediğiniz e-posta adresi
...
app.post('/saveRoomservice', async (req, res) => {
  try {
    ...
    const mailOptions = {
      ...
      to: ['factorycadde5454@gmail.com', 'info@hotel54.com.tr', 'canberkugurlu@gmail.com','batuhanozbelli54@gmail.com'],
